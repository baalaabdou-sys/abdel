...
import { segmentRulesSchema, type SegmentCondition, type SegmentRules } from '@/lib/segment-rules';
...
export {
  SEGMENT_OPERATORS, conditionSchema, segmentRulesSchema, SEGMENT_FIELDS,
} from '@/lib/segment-rules';
export type { SegmentCondition, SegmentRules } from '@/lib/segment-rules';
